  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-900">
      <div className="w-full max-w-md p-8 space-y-6 bg-gray-800 rounded-xl shadow-2xl">
        ...
        <div className="text-center">  {/* Adicionado um wrapper para centralizar */}
            <button type="button" className="text-sm text-white-500 bg-green-600! hover:underline">  {/* Adicionado estilo de link */}
            Reenviar Código
            </button>
        </div>
      </div>
